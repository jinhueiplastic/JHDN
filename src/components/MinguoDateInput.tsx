...
export default function MinguoDateInput({ value, onChange, className = "" }: Props) {
  return (
    <div className={`input relative flex items-center justify-center whitespace-nowrap ${className}`}>
